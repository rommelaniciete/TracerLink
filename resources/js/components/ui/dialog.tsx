...
export interface AppDialogContentProps extends React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> {
...
>(({ className, children, hideCloseButton = false, closeButtonDisabled = false, ...props }, ref) => {
  return (
