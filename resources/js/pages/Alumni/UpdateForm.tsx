...
export default function UpdateForm() {
    ...
    const graduationYears = Array.from({ length: currentYear - 2022 + 1 }, (_, i) => `${currentYear - i}`);
            ...
            <div className="mx-auto max-w-2xl p-6">
                <Card className="border-0 shadow-lg">
                    ...
                    <CardContent className="p-6 text-center">
                        <p className="text-lg text-muted-foreground">Alumni information has been updated successfully.</p>
    ...
    return (
        <div className="mx-auto max-w-4xl p-6">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    <label className="mb-1 block text-sm font-medium">Student Email</label>
                    <Input value={data.email} onChange={(e) => setData('email', e.target.value)} />
                </div>

                <div>
                    <label className="mb-1 block text-sm font-medium">Program Taken</label>
                ...
                <div>
                    <label className="mb-1 block text-sm font-medium">Middle Initial</label>
                ...
                <div>
                    <label className="mb-1 block text-sm font-medium">Active Email</label>
                </div>
                ...
                {data.employment_status === 'employed' && (
                    <>
                        ...
                        <div>
                            <label className="mb-1 block text-sm font-medium">Work Position</label>
                            <Input value={data.work_position} onChange={(e) => setData('work_position', e.target.value)} />
                        </div>

                        <div>
                            <label className="mb-1 block text-sm font-medium">Job Related to Course?</label>
                        ...
                        <div>
                            <label className="mb-1 block text-sm font-medium">Work Sector</label>
                        ...
                        <div>
                            <label className="mb-1 block text-sm font-medium">Work Location</label>
                        ...
                        <div>
                            <label className="mb-1 block text-sm font-medium">Employer Classification</label>
                ...
                <div>
                    <label className="mb-1 block text-sm font-medium">Are you pursuing further studies?</label>
                ...
                <div className="col-span-2">
                    <StarRating value={data.instruction_rating} onChange={(value) => setData('instruction_rating', value)} />
                </div>
